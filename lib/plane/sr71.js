...
export function buildSR71(THREE) {
  ...
  const NAC_INBOARD  = 2.1;    // inner wing outboard edge (= NAC_X, under nacelle)
  ...
  outerWing.lineTo( 5.3, -3.0);              // tip LE (brought inboard 0.5)
  outerWing.lineTo( 5.3, -3.5);              // cropped tip TE
