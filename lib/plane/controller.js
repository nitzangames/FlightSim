...
// Bank-to-turn scaling: the real-physics formula is yawRate = (g/V) * tan(β).
// Game-tuned k gives the right "feel" at typical airspeeds. tan(β) is
// monotonic in bank — more roll → more turn — exactly the MSFS feel.
// We cap the tan() at 3 (≈72° bank) so 89° doesn't blow up to a discontinuity
// and so the auto-yaw stops as the plane approaches knife-edge.
const BANK_TURN_K   = 1.0;
