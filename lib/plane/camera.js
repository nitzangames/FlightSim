...
// Camera offset tuned so the plane reads as a small craft against real-scale
// mountains. Pulled back from the original 14m to give a long-distance chase.
const OFFSET = { back: 28, up: 12, ahead: 20, lookDown: 4 };
