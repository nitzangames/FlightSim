...
// Camera offset tuned for the 0.25× world-plane scale. Smaller plane → camera
// closer in proportionally, so it still reads on screen while the big terrain
// behind dominates the frame.
const OFFSET = { back: 8, up: 3.5, ahead: 6, lookDown: 1.2 };
