...
export function buildF4(THREE) {
  ...
  // Back cone: base radius 0.70 matches the cylinder, tip at world Z=5.75
  // forms the pointy tail. Tip points +Z (rearward).
  ...
  canopy.position.set(0, 0.70, -1.5);    // sit on top of the cylinder (radius 0.70)
