...
export function buildBillboardMaterial(THREE) {
  return new THREE.ShaderMaterial({
    ...
    uniforms: {
      uBBFadeStart: { value: 1300 },
      uBBFadeEnd:   { value: 1500 },
    },
    vertexShader: `
      ...
      void main() {
        ...
        // Distance shrink-fade at LOD-1 ring edge: billboards collapse to a
        // point so they don't pop in/out as chunks load and unload.
        float fade = 1.0 - smoothstep(uBBFadeStart, uBBFadeEnd, length(toCam));
        rotated *= fade;
