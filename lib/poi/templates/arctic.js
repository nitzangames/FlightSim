...
export const ARCTIC_TEMPLATE = {
  ...
  baseProbability: 0.06,         // see forest.js — equal across all 6 templates.
                                 // Arctic eligible cells are rarer than forest
                                 // since most arctic terrain is above the 250 m
                                 // altitude ceiling, so the resulting count is
                                 // still naturally lower without an extra bump.
  sizeTiers: {
