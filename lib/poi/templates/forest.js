...
export const FOREST_TEMPLATE = {
  ...
  // contains the larger buildings + their street spacing.
  sizeTiers: {
    S: { rollMax: 0.55, buildingCount: [4, 5], padRadius: 60 },
    M: { rollMax: 0.85, buildingCount: [7, 9], padRadius: 90 },
    L: { rollMax: 1.00, buildingCount: [11, 14], padRadius: 130 },
  },
