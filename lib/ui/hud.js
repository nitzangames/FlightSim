...
export function buildHUD({ root, version, onBack }) {
  ...
  wrap.innerHTML = `
    ...
    <div data-marker-flash style="position:absolute;top:24%;left:0;right:0;text-align:center;font-size:6.5cqi;font-weight:900;letter-spacing:0.15em;color:#80ffa0;text-shadow:0 2px 10px rgba(0,0,0,0.8);display:none;">VILLAGE FOUND</div>
  ...
  function update({ speed, altitude, countdown, villageBearing, villageDistance, stalling, visitedCount, visitedTotal, flashT }) {
