...
export function buildMenu({
  ...
  wrap.innerHTML = `
    ...
    <div data-name style="position:absolute;top:58%;left:0;right:0;text-align:center;font-size:9cqi;font-weight:800;letter-spacing:0.05em;"></div>
    <div style="position:absolute;top:70%;left:6%;right:6%;display:flex;justify-content:space-between;align-items:center;">
    ...
    <button data-fly style="position:absolute;bottom:13%;left:10%;right:10%;padding:12px 0;background:#0a84ff;color:#fff;border:none;border-radius:12px;font-size:7cqi;font-weight:800;letter-spacing:0.1em;cursor:pointer;">FLY</button>
