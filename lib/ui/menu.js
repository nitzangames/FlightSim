...
export function buildMenu({
  ...
  wrap.innerHTML = `
    ...
    <button data-wallet style="position:absolute;top:3%;right:5%;font-size:4.2cqi;font-weight:800;letter-spacing:0.05em;background:#ffd766;color:#1a1a1a;border:none;border-radius:10px;padding:0.35em 0.75em;cursor:pointer;box-shadow:0 2px 6px rgba(0,0,0,0.45);">0 ★</button>
    ...
    <div data-store style="position:absolute;inset:0;display:none;flex-direction:column;align-items:center;justify-content:center;padding:0 8%;background:rgba(8,12,20,0.94);">
      <div style="font-size:7cqi;font-weight:800;letter-spacing:0.06em;color:#ffd766;">STAR STORE</div>
      <div data-store-balance style="font-size:3.4cqi;font-weight:700;opacity:0.85;margin-top:1.5%;">0 ★</div>
      <div style="font-size:3cqi;opacity:0.6;margin:3% 0 6%;text-align:center;">Exchange NBucks for stars</div>
      <div data-store-packages style="display:flex;flex-direction:column;gap:4cqi;width:100%;"></div>
      <button data-store-close style="margin-top:8%;background:rgba(255,255,255,0.08);color:#cdd6e2;border:none;border-radius:10px;padding:2.5cqi 8cqi;font-size:4cqi;font-weight:700;letter-spacing:0.08em;cursor:pointer;">CLOSE</button>
    </div>
  `;
  ...
  const pkgButtons = STORE_PACKAGES.map((pkg, i) => {
    ...
    b.style.cssText = 'display:flex;align-items:center;justify-content:space-between;gap:4cqi;background:#ffd766;color:#1a1a1a;border:none;border-radius:14px;padding:4cqi 6cqi;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.4);';
    b.innerHTML = `
      <span style="font-size:6cqi;font-weight:800;letter-spacing:0.03em;">+${fmt(pkg.stars)} ★</span>
      <span style="font-size:4cqi;font-weight:800;background:#1a1a1a;color:#ffd766;border-radius:9px;padding:0.35em 0.7em;white-space:nowrap;">${fmt(pkg.nbucks)} NB</span>
    `;
