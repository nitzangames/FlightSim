...
export const PLANES = {
  ...
  a10:      { key:'a10',      name:'A-10 Warthog',  build: buildA10,        unlock: stars(25000),    stats: { maxSpeed: 120, maxPitchRate: 0.65, maxYawRate: 0.60, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 8.5, vertRadius: 1.6 } },
  // F-16 is the 4th-gen "viper" — very agile fly-by-wire single-engine.
  f16:      { key:'f16',      name:'F-16 Falcon',   build: buildF16,        unlock: stars(35000),    stats: { maxSpeed: 145, maxPitchRate: 0.65, maxYawRate: 0.75, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.6, vertRadius: 2.6 } },
  // F-18 is heavier twin-engine carrier fighter, less raw agility than F-16
  // but excellent high-alpha character.
  f18:      { key:'f18',      name:'F-18 Hornet',   build: buildF18,        unlock: stars(42500),    stats: { maxSpeed: 145, maxPitchRate: 0.55, maxYawRate: 0.65, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.6, vertRadius: 2.2 } },
  f15:      { key:'f15',      name:'F-15 Eagle',    build: buildF15,        unlock: stars(50000),    stats: { maxSpeed: 175, maxPitchRate: 0.35, maxYawRate: 0.40, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.4, vertRadius: 2.0 } },
