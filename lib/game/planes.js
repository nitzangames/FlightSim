...
export const PLANES = {
  biplane:  { key:'biplane',  name:'WW1 Biplane',   build: buildBiplane,    stats: { maxSpeed:  55, maxPitchRate: 0.55, maxYawRate: 0.65, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 3.7 } },
  triplane: { key:'triplane', name:'WW1 Triplane',  build: buildTriplane,   stats: { maxSpeed:  50, maxPitchRate: 0.75, maxYawRate: 0.85, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 3.2 } },
  ww2:      { key:'ww2',      name:'WW2 Fighter',   build: buildWW2Fighter, stats: { maxSpeed:  95, maxPitchRate: 0.60, maxYawRate: 0.55, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.7 } },
  ...
  p51:      { key:'p51',      name:'P-51 Mustang',  build: buildP51,        stats: { maxSpeed: 115, maxPitchRate: 0.55, maxYawRate: 0.55, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.5 } },
  f86:      { key:'f86',      name:'F-86 Sabre',    build: buildF86,        stats: { maxSpeed: 130, maxPitchRate: 0.45, maxYawRate: 0.55, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.5 } },
  ...
  f4:       { key:'f4',       name:'F-4 Phantom',   build: buildF4,         stats: { maxSpeed: 155, maxPitchRate: 0.50, maxYawRate: 0.50, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.4 } },
  ...
  a10:      { key:'a10',      name:'A-10 Warthog',  build: buildA10,        stats: { maxSpeed: 120, maxPitchRate: 0.65, maxYawRate: 0.60, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 8.5 } },
  // F-16 is the 4th-gen "viper" — very agile fly-by-wire single-engine.
  f16:      { key:'f16',      name:'F-16 Falcon',   build: buildF16,        stats: { maxSpeed: 145, maxPitchRate: 0.65, maxYawRate: 0.75, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.8 } },
  // F-18 is heavier twin-engine carrier fighter, less raw agility than F-16
  // but excellent high-alpha character.
  f18:      { key:'f18',      name:'F-18 Hornet',   build: buildF18,        stats: { maxSpeed: 145, maxPitchRate: 0.55, maxYawRate: 0.65, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.5 } },
  f15:      { key:'f15',      name:'F-15 Eagle',    build: buildF15,        stats: { maxSpeed: 175, maxPitchRate: 0.35, maxYawRate: 0.40, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 6.5 } },
  f22:      { key:'f22',      name:'F-22 Raptor',   build: buildF22,        stats: { maxSpeed: 165, maxPitchRate: 0.70, maxYawRate: 0.75, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 6.8 } },
  ...
  sr71:     { key:'sr71',     name:'SR-71 Blackbird', build: buildSR71,     stats: { maxSpeed: 300, maxPitchRate: 0.25, maxYawRate: 0.30, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.6 } },
};
