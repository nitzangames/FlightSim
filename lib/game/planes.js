...
export const PLANES = {
  ...
  p51:      { key:'p51',      name:'P-51 Mustang',  build: buildP51,        unlock: stars(5000),     stats: { maxSpeed: 115, maxPitchRate: 0.55, maxYawRate: 0.55, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.5, vertRadius: 1.3 } },
  f86:      { key:'f86',      name:'F-86 Sabre',    build: buildF86,        unlock: stars(10000),    stats: { maxSpeed: 130, maxPitchRate: 0.45, maxYawRate: 0.55, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.5, vertRadius: 1.4 } },
  ...
  f4:       { key:'f4',       name:'F-4 Phantom',   build: buildF4,         unlock: stars(17500),    stats: { maxSpeed: 155, maxPitchRate: 0.50, maxYawRate: 0.50, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.4, vertRadius: 1.3 } },
  ...
  f16:      { key:'f16',      name:'F-16 Falcon',   build: buildF16,        unlock: stars(35000),    stats: { maxSpeed: 145, maxPitchRate: 0.65, maxYawRate: 0.75, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 4.8, vertRadius: 1.4 } },
  // F-18 is heavier twin-engine carrier fighter, less raw agility than F-16
  // but excellent high-alpha character.
  f18:      { key:'f18',      name:'F-18 Hornet',   build: buildF18,        unlock: stars(42500),    stats: { maxSpeed: 145, maxPitchRate: 0.55, maxYawRate: 0.65, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 5.5, vertRadius: 1.3 } },
  f15:      { key:'f15',      name:'F-15 Eagle',    build: buildF15,        unlock: stars(50000),    stats: { maxSpeed: 175, maxPitchRate: 0.35, maxYawRate: 0.40, fuelDrainRate: 0, maxFuel: 1, collisionRadius: 6.5, vertRadius: 1.4 } },
