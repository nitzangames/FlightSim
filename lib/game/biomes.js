...
export const BIOMES = [
  ...
  },
  {
    ...
    bands: {
      ...
      sand:      [0.97, 0.88, 0.55],
      grassLow:  [0.92, 0.78, 0.40],   // golden dunes (no real grass)
      grassMid:  [0.85, 0.65, 0.30],
      rock:      [0.75, 0.50, 0.30],   // red sandstone
      snow:      [0.90, 0.85, 0.65],   // pale dune tops (no actual snow)
    },
  ...
  },
  {
    ...
    hemiIntensity: 0.55,
    bands: {
      deepWater: [0.30, 0.45, 0.55],
      sand:      [0.88, 0.92, 0.95],
      grassLow:  [0.92, 0.95, 0.97],
      grassMid:  [0.84, 0.89, 0.93],
      rock:      [0.70, 0.74, 0.78],   // grey rocky outcrops
      snow:      [1.00, 1.00, 1.00],
    },
  ...
  },
  {
    ...
    hemiIntensity: 0.50,
    bands: {
      deepWater: [0.55, 0.10, 0.05],   // lava
      sand:      [0.30, 0.18, 0.13],   // dark ash
      grassLow:  [0.30, 0.12, 0.08],
      grassMid:  [0.22, 0.08, 0.05],
      rock:      [0.18, 0.08, 0.06],
      snow:      [0.85, 0.30, 0.10],   // glowing magma cracks at peaks
    },
  ...
  },
  {
    ...
    bands: {
      ...
      sand:      [0.92, 0.78, 0.45],
      grassLow:  [0.85, 0.50, 0.20],   // bright autumn orange
      grassMid:  [0.70, 0.38, 0.15],   // deep red-orange
      rock:      [0.55, 0.35, 0.20],
      snow:      [0.95, 0.92, 0.78],
    },
