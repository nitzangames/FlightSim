// Renders f16-inspect.html (live import of lib/plane/f16.js) and saves
...
(async () => {
  const out = process.argv[2] || 'f16-inspect.png';
  const url = 'http://localhost:8085/f16-inspect.html';
