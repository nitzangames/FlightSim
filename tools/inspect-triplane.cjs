// Renders triplane-inspect.html (live import of lib/plane/triplane.js) and
...
(async () => {
  const out = process.argv[2] || 'triplane-inspect.png';
  const url = 'http://localhost:8085/triplane-inspect.html';
